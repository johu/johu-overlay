...
IUSE="chrome chromium +firefox librewolf vivaldi"
REQUIRED_USE="
	${PYTHON_REQUIRED_USE}
...
src_install() {
	...
	use librewolf  && target_dirs+=( "/usr/$(get_libdir)/librewolf/native-messaging-hosts" )
	use librewolf  && target_dirs+=( "/usr/lib/librewolf/native-messaging-hosts" )
